...
def load_telechat_tokenizer(model_name_or_path):
...
def main():
    ...
    tokenizer = load_telechat_tokenizer(args.model_name_or_path)
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if args.with_loss_mask:
                ...
                loss = masked_cross_entropy_loss(logits, batch["labels"], batch["loss_mask"])
            else:
